package com.manager.stock_manager.service; // Pacote ajustado
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    private Collection<? extends GrantedAuthority> mapRolesToAuthorities(Collection<Role> roles) { // Importação ajustada
        return roles.stream()
